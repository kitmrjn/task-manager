...
{{-- ── Inject page-specific assets via Vite ── --}}
@push('styles')
...
{{-- ══════════════════════════════════════════════
     PAGE BODY
     All data comes from BoardController@index / @dashboard
     Variables: $board, $users
══════════════════════════════════════════════ --}}
<div class="tk-page-body">
                    ...
                    <div class="tk-collaborator-grid" id="dt-collaborator-selection">
                        @foreach($users as $user)
                            <div class="tk-collab-pill" data-user-id="{{ $user->id }}" onclick="toggleCollabSelection(this)">
                                <div style="width:22px;height:22px;font-size:10px;border-radius:50%;background:#2563eb;color:#fff;display:flex;align-items:center;justify-content:center;flex-shrink:0;font-weight:800;">
...
=======
            ...
            <div>
                <div class="tk-field-label">
                    Description
                    <span style="font-weight:500;text-transform:none;letter-spacing:0;color:var(--soft);font-size:12px;">(optional)</span>
                </div>
            ...
            <div>
                ...
                {{-- Swatch-only picker — no radio buttons --}}
